...
trailA_graph =  ggplot(data = alz, aes(x = as.factor(diagnosis), y=traila)) + geom_boxplot()
trailA_graph
...
```
Because the p-value, `r motor_p_val`, is less than 0.05, we can conclude that there is a relationship between motor disturbanc and diagnosis.