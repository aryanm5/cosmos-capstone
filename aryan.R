...
test_range <- 438 # Length of testing dataset (540 = 20% of training dataset)
...
xfactors <- model.matrix(bin_diag ~ as.factor(bin_games) + as.factor(bin_motsev) + as.factor(bin_hallsev) + as.factor(bin_travel))[, -1]
...
test_xfactors <- model.matrix(test_data$bin_diag ~ as.factor(test_data$bin_games) + as.factor(test_data$bin_motsev) + as.factor(test_data$bin_hallsev) + as.factor(test_data$bin_travel))[, -1]
